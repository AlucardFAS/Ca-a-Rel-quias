...
bool iniciar()
{
    ...
    tela_inicio= al_load_bitmap("itensfundos/telainicio.png");
    if (!tela_inicio)
    {
        fprintf(stderr, "Falha ao carregar tela de inicio.\n");
        al_destroy_display(janela);
        al_destroy_event_queue(fila_eventos);
        al_destroy_bitmap(fundo);
        al_destroy_bitmap(esquerda[0]);
    ...
    porta_final= al_load_bitmap("itensfundos/portafinal.png");
    if (!tela_inicio)
    {
        fprintf(stderr, "Falha ao carregar porta final.\n");
        al_destroy_display(janela);
        al_destroy_event_queue(fila_eventos);
        al_destroy_bitmap(fundo);
        al_destroy_bitmap(esquerda[0]);
